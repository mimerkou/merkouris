    ...
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-28 xl:text-left h-full container mx-auto">
          ...
          >
            ...
            and <span className="text-accent">Marketing</span>
          ...
          */}
          ...
          <motion.div
            ...
            animate="show"
            exit="hidden"
            // className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-7 xl:mb-9 w-[50%]"
          >
            <AboutBtn />
          </motion.div>
        </div>
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        ...
        <motion.div
          ...
          className="w-full h-full max-w-[537px] max-h-[478px] absolute -bottom-32 lg:bottom-0 lg:right-[6%]"
        >
          <Avatar />
        </motion.div>
      </div>
